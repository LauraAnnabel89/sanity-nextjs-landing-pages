...
const SECTION_PROPS = ["type", "theme"];
            ...
            <>
              <div className="row">
                ...
                <div className="col-xs-12 col-md-8 work-single__overview-expand">
                  <div
                    className={`work-single__overview-expand-link work-single__overview-expand-link--${
                      infoExpanded[_key] ? "rotated" : "normal"
                    }`}
                    onClick={() => this.onInfoClick(_key)}
                  >
